 ...
 * Write a class that contains the fol-lowing two methods:/** Convert from Celsius to Fahrenheit
...
public class Ex0508 {
    ...
    public static void main(String[] args) {
        ...
        for (double celsius = 40.0, fahrenheit = 120.0; celsius >= 31.0; celsius--, fahrenheit -=10) {
            ...
            System.out.printf("%-18.1f|",celsiusToFahrenheit(celsius));
            System.out.printf("     %-15.1f",fahrenheit);
            System.out.printf("%-7.2f\n\n",fahrenheitToCelsius(fahrenheit));
        }
    }

    /** Method that convert from Celsius to Fahrenheit. */
    public static double celsiusToFahrenheit(double celsius) {
        return (9.0 / 5) * celsius + 32;
    }

    /** Method that convert from Fahrenheit to Celsius. */
    public static double fahrenheitToCelsius(double fahrenheit) {
