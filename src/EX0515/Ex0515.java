...
public class Ex0515 {
    ...
    public static void main(String[] args) {
        ...
        // Display table
        System.out.println(
                " Taxable      Single    Maried Joint      Married       Head of\n " +
        ...
        for (double taxableIncome = from; taxableIncome <= to;taxableIncome += interval) {
            ...
            System.out.printf("%-15d", Math.round(computeTax(0, taxableIncome)));
            System.out.printf("%-15d", Math.round(computeTax(1, taxableIncome)));
            System.out.printf("%-15d", Math.round(computeTax(2, taxableIncome)));
            System.out.printf("%-15d%n", Math.round(computeTax(3, taxableIncome)));
        }
    }

    /** Method that computes a tax. */
        ...
        switch (status) {
            ...
            case 3:
                if (taxableIncome <= 11950)
                    ...
                    tax = 11950 * 0.10 + (4550 - 11950) * 0.15 +
